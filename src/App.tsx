        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b-2 border-dashed border-zinc-800 pb-6">
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold tracking-tight text-zinc-100 uppercase font-mono">台海戰情即時情報網 <span className="text-xs text-zinc-600 font-mono ml-2">v2.6</span></h1>
            </div>
